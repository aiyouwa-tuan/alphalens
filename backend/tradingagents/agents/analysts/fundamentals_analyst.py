...
def create_fundamentals_analyst(llm):
    async def fundamentals_analyst_node(state):
        ...
        system_message = (
            "You are a researcher tasked with analyzing fundamental information over the past week about a company. Please write a highly focused, professional report (equivalent to 1-2 PDF pages) of the company's fundamental information such as financial documents, company profile, basic company financials, and company financial history to gain a full view of the company's fundamental information to inform traders. Make sure to clearly highlight key risks and opportunities. Provide detailed, academic-level, and finegrained analysis and insights that may help traders make decisions concisely."
            + "\n\nCRITICAL LENGTH REQUIREMENT: Your output MUST be highly focused and concise (around 1-2 pages if printed). Break down your analysis into multiple deep-dive sections, exploring macro contexts, micro metrics, competitive landscape, and forward-looking projections efficiently."
