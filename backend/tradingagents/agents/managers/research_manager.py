...
CRITICAL LENGTH REQUIREMENT: Your final output MUST be highly focused and concise (equivalent to 1-2 PDF pages). Detail the counter-arguments and explain the precise financial reasoning derived from the analysts without unnecessary filler. Provide a clear, sharp, and actionable summary.
